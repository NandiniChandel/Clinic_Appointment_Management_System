      ...
      <div className='flex items-center gap-4'>
        {
          token?<div className='flex items-center gap-2 cursor-pointer group relative'>
            ...
            <div className='absolute top-0 right-0 pt-14 text-base font-small text-gray-600 z-20 hidden group-hover:block'>
              <div className='min-w-48 bg-stone-100 flex flex-col gap-4 p-4  '>
                ...
                <p className='hover:text-red-600 cursor-pointer text-red-400' onClick={()=>{
                  setToken(false)
                }}>Logout</p></div>
            </div>
